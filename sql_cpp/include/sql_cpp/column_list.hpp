...
template <auto FirstMemberPtr, auto... OtherMemberPtr> struct ColumnList {
    ...
    using class_type = typename detail::MemberPointerTraits<FirstMemberPtr>::class_type;
    using table_type = typename detail::Table<class_type, FirstMemberPtr, OtherMemberPtr...>;
  ...
  private:
    template <auto First, auto... Args> static consteval bool CheckSameClassType() {
        using CurrentClassMemberPtrType = typename detail::MemberPointerTraits<First>::class_type;
